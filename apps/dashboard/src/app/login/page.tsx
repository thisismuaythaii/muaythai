...
function LoginContent() {
  ...
  const handleSuccess = async (credentialResponse: any) => {
    ...
    try {
      ...
      setError(err.message || "Administrative access denied.");
      console.error(err);
    } finally {
...
export default function LoginPage() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-black font-sans">
      {/* Background with ring feel - Sync with Web App */}
      <div 
      ...
      >
        <div className="flex flex-col items-center text-center mb-10 w-full">
          ...
          <div className="flex flex-col gap-1">
              ...
              <h1 className="text-4xl font-bold tracking-tighter text-white uppercase">Admin <span className="text-white/40">Portal</span></h1>
          </div>
